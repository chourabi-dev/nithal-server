...
public class Vehicules {
    ...
    private int hauteurV;
    private int largeurV;
	...
	public int getHauteurV() {
		return hauteurV;
	}

	public void setHauteurV(int hauteurV) {
		this.hauteurV = hauteurV;
	}

	public int getLargeurV() {
		return largeurV;
	}

	public void setLargeurV(int largeurV) {
